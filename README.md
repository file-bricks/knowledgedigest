...
**v0.4.0 (Latest)**
- **Gemini Flash Summarizer**: Extreme high-speed API option (`--flash`) added for LLM summarization (default model `gemini-2.0-flash`, configurable via `GEMINI_MODEL`; requires the optional `google-genai` package).
