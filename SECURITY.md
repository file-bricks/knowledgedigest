...
2. **Use GitHub's [private vulnerability reporting](https://github.com/file-bricks/knowledgedigest/security/advisories/new)**
3. Include: description, steps to reproduce, potential impact

### How to Report

1. Go to: https://github.com/file-bricks/knowledgedigest/security/advisories/new
